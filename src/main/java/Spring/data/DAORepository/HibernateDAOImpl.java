...
import Spring.data.hibernateConfig.HibernateConfig;
...
public class HibernateDAOImpl implements HibernateDAO{
    ...
    public void save(Object C){
        Session session = hibernateConfig.CreateSessionFactory(C.getClass()).openSession();
    ...
    public <T> void delete(Class<T> C, Integer id) throws InstantiationException, IllegalAccessException {
        Session session = hibernateConfig.CreateSessionFactory(C).openSession();
        session.beginTransaction();
